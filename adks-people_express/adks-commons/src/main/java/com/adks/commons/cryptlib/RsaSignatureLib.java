...
public class RsaSignatureLib {
    ...
    public static byte[] sign(RsaSignatureAlgorithm algorithm, PrivateKey privateKey,
                              String data)
    ...
    public static boolean verify(RsaSignatureAlgorithm algorithm, PublicKey publicKey,
    ...
    public static boolean verify(RsaSignatureAlgorithm algorithm, PublicKey publicKey, byte[] data,
