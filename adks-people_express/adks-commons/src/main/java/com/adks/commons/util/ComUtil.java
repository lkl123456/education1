...
/** 
 * @ClassName: ComUtil 
 * @Description: TODO(共用工具类 判断是否是空值) 
 * @author harry 
 * @date 2017年1月9日 下午2:39:51 
 *  
*/
public class ComUtil {
	...
	public static boolean isNotNullOrEmpty(String str) {
		...
		if (str == null||str.trim().equals("")
			||str.trim().equals("null")||str.trim().equals("undefined")) {
	...
	public static String delNUllString(Object fNullString)
	  {
	    String strNull = "";
	    if ((fNullString == null) || (fNullString.toString().trim().equals("")) || (fNullString.toString().trim().equalsIgnoreCase("null"))) {
	      return strNull.trim();
	    }
	    return fNullString.toString().trim();
	  }
