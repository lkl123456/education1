package com.adks.commons.connhelper;
...
public class HttpURLConnHelper {
	...
	/**
	 * 
	 * @Title loadFileFromURL
	 * @Description：实现网络访问文件，将获取到数据储存在文件流中
	 * @author xrl
	 * @Date 2017年5月11日
	 * @param urlString
	 * @return
	...
	/**
	 * 
	 * @Title loadByteFromURL
	 * @Description：实现网络访问文件，将获取到的数据存在字节数组中
	 * @author xrl
	 * @Date 2017年5月11日
	 * @param url
	 * @return
	...
	/**
	 * 
	 * @Title saveFileFromURL
	 * @Description：实现网络访问文件，将获取到的数据保存在指定目录中
	 * @author xrl
	 * @Date 2017年5月11日
	 * @param url
	 * @param destFile
	 ...
	 * 
	 * @Title doPostSubmit
	 * @Description：实现网络访问文件，先给服务器通过“POST”方式提交数据，再返回相应的数据
	 * @author xrl
	 * @Date 2017年5月11日
	 * @param url：访问url时，需要传递给服务器的参数。格式为：username=aaa&password=aaa
	 * @param params
	 * @return
	 */
	 ...
	 */
	public static String doPostSubmitBody(String url, Map<String, String> map, String filePath, byte[] body_data,
			String charset) {
