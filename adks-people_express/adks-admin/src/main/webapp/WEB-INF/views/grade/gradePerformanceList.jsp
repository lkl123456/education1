...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/grade/js/gradePerformance.js"></script>
<body class="easyui-layout">
	...
	<div id="tb" style="padding:15px 10px 10px 10px;height:auto; overflow:hidden; ">
		...
		<div style="margin-bottom:5px; float:right;">
			<a href="javascript:updateAllGradeUserGraduate()" class="easyui-linkbutton" iconCls="icon-reload" plain="true">更新结业状态</a>
			<a href="javascript:updateAllGradeUserCredit()" class="easyui-linkbutton" iconCls="icon-reload" plain="true">更新用户学时</a>
			<a href="javascript:exportGradePerformanceExcel()" class="easyui-linkbutton" iconCls="icon-print" plain="true">导出Excel</a>
		</div>
	</div>
	<!-- 列表 -->
	<div id="mainText" data-options="region:'center'">
			<table id="gradePerformanceListTable" style="width:800px;height:350px;" class="easyui-datagrid"
					toolbar="#tb" data-options="
					url:'${pageContext.request.contextPath}/gradePerformance/getGradePerformanceListJson',
					method:'post',
					singleSelect:false,
					collapsible:true,
					fit:true,
				...
				<thead>
					<tr>
						...
						<th data-options="field:'isGraduate'" formatter="graduateStatus" align="center" width="50">结业状态</th>
	...
	<div style="padding-top: 2px; padding-left: 20px; z-index: 0;">
		<form id="export_gradePerformance" method="post" action="${pageContext.request.contextPath}/gradePerformance/exportGradePerformance">
