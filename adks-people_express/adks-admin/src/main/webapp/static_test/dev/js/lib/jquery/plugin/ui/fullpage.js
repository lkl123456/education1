...
(function($) {
  $.fn.fullpage = function(options) {
    ...
    */
    ...
    var container = $(this);
    var windowsHeight = ($(window).width() > $(window).height() ? $(window).height() : $(window).width()*0.8);
    var isMoving = false;
    ...
    */
    $(document).on('click touchstart', '.fp-slidesNav a', function(e){
      ...
      var destiny = slides.find('.fp-slide').eq($(this).closest('td').index());
    ...
    */
    function landscapeScroll(slides, destiny){
      ...
      slidesNav.find('tr td').eq(slideIndex).find('a').addClass('active');
    }
    ...
    $.fn.fullpage.reBuild = function(){
      ...
      windowsHeight = windowsWidth > windowsHeight ? windowsHeight : windowsWidth*0.8;
    ...
    */
    function addSlidesNavigation(section, numSlides){
      section.append('<div class="fp-slidesNav"><table style="table-layout: fixed;"><tr></tr></table></div>');
      var nav = section.find('.fp-slidesNav');
      var sections = section.find('.fp-slide').map(function(index){ return $(this) });
      //top or bottom
      nav.addClass(options.slidesNavPosition);

      for(var i=0; i< numSlides; i++){
        nav.find('tr').append('<td><a href="#">'+sections[i].attr('title')+'<span></span></a></td>');
      }
      //centering it


      nav.find('td').first().find('a').addClass('active');
    }
