package com.adks.dbclient.dao.multitanent;

import com.adks.dbclient.mysql.MultitenantMysqlClient;
 ...
 */
abstract public class MultitenantBaseDao {

    @Resource
    protected MultitenantMysqlClient mysqlClient;
    ...
    public int insert(Map<String,Object> insertColumnValueMap) {
        ...
        int id = mysqlClient.insertAndGetKey(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                PreparedStatement ps = con.prepareStatement(mysqlClient.parseSql(finalInsertSql), Statement.RETURN_GENERATED_KEYS);
